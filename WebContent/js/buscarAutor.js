...
function llamadaANombreAutores() {
	...
	if (req){
		...
		req.open("POST", "buscarAutor.do", true);
...
function funcionAsincronaRecepcionNombre(){
	...
	if (ready == READY_STATE_COMPLETE){
		...
		document.getElementById("main").innerHTML = data[0];

		document.getElementById("pie").innerHTML = data[1];
	}
}
...
function funcionAsincronaRecepcionDatosAutores(){
	...
	if (ready == READY_STATE_COMPLETE){
		...
		document.getElementById("datos").innerHTML = data[0];
